 ...
 */
public class wordAdapter extends ArrayAdapter<textView> {
     ...
     */
    public wordAdapter(Activity context, ArrayList<textView> androidFlavors, int colorResourceID) {
...
//        return super.getView(position, convertView, parent);
        ...
        TextView nameTextView = (TextView) listItemView.findViewById(R.id.miwokNumberList);
        // Get the version name from the current AndroidFlavor object and
        // set this text on the name TextView
        nameTextView.setText(currentNumberList.getMiwokTranslation());

        // Find the TextView in the list_item.xml layout with the ID version_number
        TextView translationTextView = (TextView) listItemView.findViewById(R.id.englishNumberList);
        // Get the version number from the current AndroidFlavor object and
        // set this text on the number TextView
        translationTextView.setText(currentNumberList.getDefaultTranslation());
